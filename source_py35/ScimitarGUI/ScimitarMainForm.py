...
import ScimitarCore
from ScimitarGUI.ScimitarRunForm import *
from ScimitarGUI.ScimitarHelpBrowserLegacy import *
from ScimitarGUI.ScimitarUncertaintyFormatterForm import *
from ScimitarGUI.ScimitarAnalysisForm import *
...
class ScimitarMainForm( wx.Frame ):
	...
	def InitializeUI( self ):
		...
		toolbar_newRun = toolbar.AddTool( wx.ID_ANY, "New Run", newRun_bmp, shortHelp = "Create a new run file." )
		...
		self.log.WriteLogText("Version 6.0.7 (Feb 2018)\n")
...
Research Fellowship Program under Grant No. DGE1144081."""
		...
		info.SetVersion('6.0.7 (Feb 2018)')
