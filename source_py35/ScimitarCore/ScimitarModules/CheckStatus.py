...
class CheckStatus( PreExecutionModule ):
    ...
    def getScriptContribution( self ):
        ...
        if self.run.runSettings.optionGenerateCheckStatusScript:
            ...
            contribution += "checkStatusScript.write(\"runListing = \" + str( runListing ) + \"\\n\")\n"
            contribution += "checkStatusScript.write('jobID = 0\\n')\n"
            contribution += "checkStatusScript.write('numRunningJobs = 0\\n')\n"
            contribution += "checkStatusScript.write('for job in runListing:\\n')\n"
            ...
            contribution += "checkStatusScript.write('        numRunningJobs += 1\\n')\n"
            ...
            contribution += "checkStatusScript.write('print(\">> \" + str(numRunningJobs) + \" of \" + str(jobID) + \" jobs have executed.\")\\n')\n"
